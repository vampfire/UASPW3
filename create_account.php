...
<section class="section-padding bg-light" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <div class="section-title">
                        <h1 class="display-4 text-white fw-semibold">Create New Game Account</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <form action="tambah_proses.php" method="post" class="row g-3 p-lg-5 p-4 bg-white theme-shadow">

                        <div class="form-control col-sm-6 d-grid" label for="inputState">
                            <input type="text" name="Kode" placeholder="Enter Game Code">
                        </div>

                        <div class="form-control col-lg-6 d-grid" label for="inputState">
                            <input type="text" name="Nama" placeholder="Enter Game Username">
                        </div>
...
<div class="col-md-12">
    ...
    <option value="Roblox">Roblox</option>
                        ...
                        <div class="form-group col-lg-12 d-grid">
                            <br>
                            <input type="submit" name="tambah" value="ADD" button class="btn btn-brand"></button>
                        </div>
                    </form>
                </div>
            </div>
