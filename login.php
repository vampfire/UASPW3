...
<section class="section-padding bg-light" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <div class="section-title">
                        <h1 class="display-4 text-white fw-semibold">Login</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <form method="post" action="aksi_login.php" class="row g-3 p-lg-5 p-4 bg-white theme-shadow">

                        <div class="form-control col-sm-6 d-grid" label for="inputState">
                            <input type="text" class="masuk" autocomplete="off" placeholder="Your Name" name="username" autofocus required>
                        </div>


                        <div class="form-control col-sm-6 d-grid" label for="inputState">
                            <input type="password" class="masuk" autocomplete="off" placeholder="Your Password" name="password" autofocus required>
                        </div>
                      
     
                        <div class="form-group col-lg-12 d-grid">
                            <br>
                         <input id="tombol" type="submit" value="Login" button class="btn btn-brand"></button>
<br>
                        </div>

                        
                        <div class="d-grid gap-2">
                        Don't have Inflowy account? Register!
